  ...
  <div class="option option-option-tree-slider">
    ...
    <div class="section">
      <div class="element">
        ...
        <a href="#" id="<?php echo $value->item_id; ?>" class="button button-framework light add-slide right">Add Slide</a>
      </div>
      ...
      foreach( $image_slider_fields as $field ) {
        ...
        if ( $field['name'] == 'image' ){ ?>
          <div>
            ...
            <input id="upload_<?php echo $id ?>-<?php echo $count ?>-<?php echo $field['name'] ?>" class="button upload_button" type="button" value="Upload" rel="<?php echo $int; ?>" />
